...
const SAMPLE_PAYLOAD_FACTORIES: SamplePayloadFactoryMap = {
  ...
  'admin.affiliate.purchase': () => ({
    ...
    affiliateUserId: 'user_affiliate_sample',
    amountUsd: 600,
    customerEmail: 'new-customer@example.com',
    entityId: 'commission_sample_created',
    plan: 'regen',
    referralCode: 'RAYD8A1',
    referredUserId: 'user_referred_sample',
    stripeCustomerId: 'cus_affiliate_sample',
    stripeInvoiceId: 'invoice_affiliate_sample',
    stripeSubscriptionId: 'sub_affiliate_sample',
  }),
